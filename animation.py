...
class AnimateSprite(pg.sprite.Sprite):
    def __init__(self, entity_type, sprite_name, action, direction):
        ...
        # self.image = pg.image.load(os.path.join(HOME_DIRECTORY, entity_type, sprite_name, update_actions,
        #                                             direction, f"{sprite_name}_{update_actions}_{direction}_0.png"))
        self.image = pg.transform.scale(
            pg.image.load(os.path.join(ASSETS_DIRECTORY, entity_type, sprite_name, action, direction,
...
def load_animation_images(entity_type, sprite_name, action, direction):
    ...
    """
    images = []
    path = os.path.join(ASSETS_DIRECTORY, entity_type, sprite_name, action, direction)
...
directions = [LEFT, LEFT_TOP, TOP, RIGHT_TOP, RIGHT, RIGHT_BOTTOM, DOWN, LEFT_BOTTOM]
